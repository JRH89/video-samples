...
const Home = () => {
  const videos = [
    ...
    "https://firebasestorage.googleapis.com/v0/b/builders-land.appspot.com/o/videos%2F10-24_3.mp4?alt=media&token=5015cbce-af2a-4bc2-905e-8e285d964d6f",
  ...
  return (
    <>
      ...
      <div className="bg-gray-100 min-h-screen p-6 my-auto place-content-center mx-auto flex flex-col">
        <div className="max-w-screen-lg mx-auto">
          <h1 className="text-2xl underline font-bold mb-4 text-center text-neutral-950">Image Samples</h1>
          <div className="space-y-4">
